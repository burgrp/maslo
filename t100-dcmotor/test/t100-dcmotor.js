module.exports = ({ i2c, address, maxRetries = 2, motorPolarity = 1, encoderPolarity = 1 }) => {
    ...
    return {
        ...
        async get() {
            ...
            return {
                duty: motorPolarity * duty / 0xFF,
                steps: encoderPolarity * buffer.readInt32LE(2),
